...
const tronWeb = new TronWeb({
  ...
  // headers: { "TRON-PRO-API-KEY": "47a01e67-987c-4d63-af2d-4ab196d489a0" },
});

var createTRONAddress = async () => {
  const account = await tronWeb.createAccount();
  // const isValid = tronWeb.isAddress(account.address.base58);
  return account
}


const transferTron = async (target, amount, address, privateKey) => {
  try {
...
const TrxcheckBalance = async (address) => {
  try {
...
exports.TrxcheckBalance = TrxcheckBalance
exports.transferTron = transferTron
exports.createTRONAddress = createTRONAddress
